...
<div class="hero-section">
  <div class="hero-content">
    ...
    <p class="hero-slogan">基于源码插桩 + GDB 验证 + 反事实讨论的 JVM 源码解析</p>
    <p class="hero-desc">14 卷 · ~230 章 · 从编译你的第一个 JVM 到 c2 寄存器分配</p>
...
* [第一章 — 方法与路径](openjdk/vol-00/ch01.md) - 这本书为什么不一样
* [第二章 — 第一次 GDB 断点](openjdk/vol-00/ch02.md) - java -version 的调用栈
* [第三章 — OpenJDK 源码全景](openjdk/vol-00/ch03.md) - 39 模块 + 22 个 .so
* [第四章 — 搭建编译环境](openjdk/vol-00/ch04.md) - 从零到可编译
* [第五章 — 理解 configure](openjdk/vol-00/ch05.md) - autoconf 在做什么
* [第六章 — make 的 5 个阶段](openjdk/vol-00/ch06.md) - 从源码到 JDK image
* [第七章 — 二进制审核](openjdk/vol-00/ch07.md) - file / readelf / ldd / nm 实战
* [第八章 — GDB 工具箱](openjdk/vol-00/ch08.md) - 6 个命令够用整本书
* [第九章 — 第一次修改 JVM 源码](openjdk/vol-00/ch09.md) - 改一行 → 编译 → 生效
* [第十章 — HotSpot 源码地图](openjdk/vol-00/ch10.md) - 接下来去哪
