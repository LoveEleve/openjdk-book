...
>
> **前置依赖**：[ch11/10](10-queue-system-init.md)（队列系统初始化完毕）。
...
> **下一篇**：[12b 补章](12b-compressed-oops-and-tlab.md)——`initialize_heap()` 剩余阶段 ③④⑤（TLAB 上限、压缩指针、TLAB 启动），随后是 [ch11 总结](12-summary.md)。
