...
| 第 3 批（对象/类） | 07-classfile-classloader（[01-classfile-parser](07-classfile-classloader/01-classfile-parser.md) / [02-verifier-stackmap](07-classfile-classloader/02-verifier-stackmap.md) 完成,03-07 待写）；09-memory-core / 17-threads | 进行中 |
