...
| 第 2 批（原语） | 02-assembler（[01-codebuffer-abstract-assembler](02-assembler/01-codebuffer-abstract-assembler.md) / [02-x86-register-operand-encoding](02-assembler/02-x86-register-operand-encoding.md) / [03-x86-assembler-instruction-set](02-assembler/03-x86-assembler-instruction-set.md) / [04-x86-macroassembler-runtime](02-assembler/04-x86-macroassembler-runtime.md) 完成 — **02 域完结**）；03-arguments-flags（[01-flag-definition-system](03-arguments-flags/01-flag-definition-system.md) 完成,02 待写） / 03-flags / 04-logging / 06-oops / 16-codecache / 38-perfdata / 41-zipjimage / 42-core-native | 进行中 |
