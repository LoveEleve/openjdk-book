...
4. 文件名 `10-queue-system-init.md`，前置依赖标注 `[ch11/09](09-g1-policy-init.md)`
...
3. 文件名 `11-allocator-ready-and-cleanup.md`，前置依赖标注 `[ch11/10](10-queue-system-init.md)`
...
1. 先读源码 `/data/workspace/jdk11u/src/hotspot/share/gc/g1/g1CollectedHeap.cpp:1679-1707`
2. 用 Agent 工具深度探索 5 个初始化方法各自做了什么
3. 参照标杆文章 `/data/workspace/LoveEleve.github.io/docs/openjdk/vol-01/ch11/07-g1-concurrent-mark-creation.md` 的结构和深度撰写
4. 文件命名 `10-queue-system-init.md`，放在 `/data/workspace/LoveEleve.github.io/docs/openjdk/vol-01/ch11/` 目录
5. 前置依赖标注 `[ch11/09](09-g1-policy-init.md)`
