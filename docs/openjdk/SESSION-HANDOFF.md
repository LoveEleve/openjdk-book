...
> **状态**: 2026-08-12 | 卷 2 写作中: **22/152 篇完成**(第 1 批 12 篇 ✅ 全部完结;第 2 批 12 篇,06-oops 域 04 完成,05 待写) | 上下文已满,本文件为**非常详细交接版**——新 AI 只读本文件即可继续
...
**下一步(唯一,无选择)**: 06-oops/05(access-api-barrier,Access API 与 GC barrier)——06 域 6 篇: 01-04 已完,05-06 待写。
...
第 2 批(原语): 02(4 篇) → 03(2 篇) → 04(2 篇) → 06(6 篇) → 16(5 篇) → 38(2 篇) → 41(2 篇) → 42(3 篇)   🚧 进行中(12/26,06 域 4/6)
第 3 批(对象/类): 07 → 09 → 17
...
**已完成 22 篇**(全部在 `docs/openjdk/vol-02/`):
...
- [ ] **06-oops/05**(access-api-barrier)——06 域剩 2 篇(05-06)
...
```
1. 读 planning/outlines/06-oops/05-access-api-barrier.md(大纲)
2. 验证大纲所有 file:line(按 §六 的漂移规律,重点: Access 模板/barrier 后端/装饰器机制是否编造)
