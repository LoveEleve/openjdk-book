...
> **状态**: 2026-08-12 | 卷 2 写作中: **20/152 篇完成**(第 1 批 12 篇 ✅ 全部完结;第 2 批 8 篇,04 域完结,06-oops 待写) | 上下文已满,本文件为**非常详细交接版**——新 AI 只读本文件即可继续
...
**下一步(唯一,无选择)**: 06-oops(第 2 批第 4 域,6 篇,01-markoop-oopdesc.md 起)。
...
第 2 批(原语): 02(4 篇) → 03(2 篇) → 04(2 篇) → 06(6 篇) → 16(5 篇) → 38(2 篇) → 41(2 篇) → 42(3 篇)   🚧 进行中(8/26,04 域完结,06 待写)
第 3 批(对象/类): 07 → 09 → 17
...
**已完成 20 篇**(全部在 `docs/openjdk/vol-02/`):
...
| 04-logging | 2 | `04-logging/02-output-and-configuration.md`(265 行) | ✅ 本会话完成+深审 — **04 域完结** |
...
- [ ] **06-oops**(第 2 批第 4 域,对象模型,6 篇——04-logging/02 的悬念桥接指向它;05-cpu/02 的悬念桥接也指向它)
...
```
1. 读 planning/outlines/06-oops/01-markoop-oopdesc.md(大纲)
2. 验证大纲所有 file:line(按 §六 的漂移规律,重点: 对象头字段布局/mark word 编码是否编造)
