...
> **状态**: 2026-08-12 | 卷 2 写作中: **21/152 篇完成**(第 1 批 12 篇 ✅ 全部完结;第 2 批 9 篇,06-oops 域 01 完成,02 待写) | 上下文已满,本文件为**非常详细交接版**——新 AI 只读本文件即可继续
...
**下一步(唯一,无选择)**: 06-oops/02(klass-hierarchy,Klass 层次)——06 域 6 篇: 01 已完,02-06 待写。
...
第 2 批(原语): 02(4 篇) → 03(2 篇) → 04(2 篇) → 06(6 篇) → 16(5 篇) → 38(2 篇) → 41(2 篇) → 42(3 篇)   🚧 进行中(9/26,06 域 1/6)
第 3 批(对象/类): 07 → 09 → 17
...
**已完成 21 篇**(全部在 `docs/openjdk/vol-02/`):
...
| 06-oops | 1 | `06-oops/01-markoop-oopdesc.md`(207 行) | ✅ 本会话完成+深审 2 轮(见 §六 06 域修正) |
...
- [ ] **06-oops/02**(klass-hierarchy,Klass 层次与 vtable)——06 域剩 5 篇(02-06)
...
```
1. 读 planning/outlines/06-oops/02-klass-hierarchy.md(大纲)
2. 验证大纲所有 file:line(按 §六 的漂移规律,重点: Klass 布局/vtable 偏移/元数据大小是否编造)
