...
> - **ModuleEntryTable : Hashtable<Symbol*, mtModule>**(moduleEntry.hpp:208)+ 静态 _javabase_module(:216,javabase_moduleEntry() :255)——**模块表 per-loader**(ClassLoaderData._modules,classLoaderData.hpp:252 "The modules defined by the class loader")非全局;java.base 条目启动早期预置(moduleEntry.hpp:198-206 注释: 模块系统初始化前加载的类的 PackageEntry 要指向它)
