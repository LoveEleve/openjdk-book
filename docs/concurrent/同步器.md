...
![](images/OCsybQA8JoLQCRxfB6hclg2UnXg.png)
...
![](images/UwU6b4RMJocFspxF0E1cZi9KnGg.png)
...
![](images/W66Tbr5tVoucjVxggVqcGek8n5d.png)



**构造函数：** 初始状态如下图所示：

![](images/EQTsbnKCyo96U0xaQY4cvqYKnQf.png)
...
![](images/RwK9btJIwoU8lsx4D0KctNj1nYc.png)

示例图

### 类关系图

![](images/Zu3NbgDFtoH1vJxIplqcbeggnWc.png)
...
![](images/PUvDb2bQgoc3krxenSRcHpdWn2t.png)



构造函数： 初始状态如下图所示：&#x20;

![](images/WgdbbUA5ZoaeazxhrTlcEsbbnKh.png)
...
![](images/Ib36bXZJ5oOpVqxU3aPc3WEOnqd.png)



### 类关系图

![](images/Ku05bBe1IoC54fxwxW3cJOzWnqe.png)



### 源码解析

![](images/ZQWnbEAKroM0FXxspHscu6d4nOg.png)



**构造函数：** 初始状态如下：&#x20;

![](images/AbaHbtLNFowImrxsSnYcMixmncg.png)
...
![](images/TuwDbqt31oJveUxxtpZcdtWknvd.png)
...
![](images/LaK0b8cAJozPO1xAUbAcxQyKnqb.png)
...
![](images/ChXqb4Ay5oRSxfxgFoCc35nzneg.png)



![](images/Cb6Cb71XJoQzXVxw9IocpDkin3c.png)
...
![](images/Mr4ZbjoSaopPy9xi51zcwXeOnHe.png)
...
![](images/JbT5bqLkQoRNK7xSuP8cKxJCngX.png)
...
![](images/XSlQbriuvoMRH8xrn6YcoKJanbh.png)
...
![](images/WNIpbUnLgogET1xHuQkcGWVXnFc.png)
...
![](images/Ky7kbNkCVov1Spx9Xk6czRZ0nIf.png)



### 类关系图

![](images/UmPpb269AoarSLx82GXcBXRBnvd.png)



先介绍其最为重要也最好理解的属性：state 在Phaser中state的不同位有不同的作用，如下图所示：&#x20;

![](images/GFckblzgrodK1UxDSYLcRD4jn5o.png)



从官网的介绍上来看,它的一般原理为：但是实际上更加的复杂和灵活

![](images/AJsNbwxXuoL6j2x9hbPcB9Dsnrf.png)



### 源码解析

![](images/W94nbD63GobKTdxWt5dcg3IUnhf.png)
...
![](images/WWxebvgGPojqW4xW8Mdc1p7ynFU.png)
...
![](images/OOEnbxPlxo4AWWx9NR4cqbC4nKe.png)



&#x20;2.初始化state&#x20;

![](images/Sv3pbRqFRo9VSvxI8Y6ce1EZnze.png)
...
![](images/Pq9sbTEm7orEM5xWUs9cM9ERnsh.png)
...
![](images/XWP1bDqZSobn5GxdfrAc8JFNn5e.png)
...
![](images/A9WwbJZStolcN2xUlH9cUp6LnLd.png)
...
![](images/DNsCb2XnVobQmSxhpZXcd024noc.png)



核心逻辑如下图所示：&#x20;

![](images/D1iUbtubzoiR0nxFh3Qc5g1envd.png)
...
![](images/KU62bsxLFoJsdnx8wewcrLzYngd.png)
...
![](images/XowtbNyW3oal5Exn4sIcuOldnKh.png)
...
![](images/K7EJbVy1SobUCAxPwT9coafInCb.png)



接下来继续看入队的代码： 此时的状态如下：

![](images/FNJ4btcYKoMXqpx4z3rcrh1tnTd.png)
...
![](images/Ezw5bzzsloEf1xxWYymcEUlsnzb.png)



![](images/QzXYbRLoNo41ioxL8GAcyHftnUe.png)
...
![](images/YIYqbjdTro80CQxHHEocTR3tnDb.png)
...
![](images/YOOYbeNwLoQE0WxxVxxcOwJzn0f.png)



### 源码解析：

![](images/YTEyb5MTzo4tAmxkqyrcw2zdnec.png)
...
![](images/Adr6bJsXvorK9HxrSH3cDu8Mn3d.png)
...
![](images/Kx08bl2MvokJ61xmZO3cCfIIn4c.png)
...
![](images/PnskbER4qogkkQxfBKwcHR0Vn1b.png)
...
![](images/Zh1gbB4nWoVJBWxuFfucqKLenOe.png)
...
![](images/MdzQbxRXxou9DMxBGNociJYVnOe.png)
...
![](images/UjG7bOKeJof97HxiTIVcwDehnre.png)



到这里关于单个slot的匹配操作已经介绍的差不多了。下面再介绍一下关于arena\[]的相关操作,此时的结构如下图所示：&#x20;

![](images/SeX5bhWtRo7QXlxpw4tc5FyvnJf.png)
...
![](images/WZGAbT07coWxuXxwC6ecodNNnfb.png)
...
![](images/UyinbaeQrotLdAxPiUPcPWq4nlf.png)
...
![](images/ZGdtbRP7eougWqxfqUscH7z7nfc.png)
...
此时再回头看下arenaExchange()方法: 重点看第三个分支： 当线程对应的节点对应的index(初始默认为0)在arena\[index]中不为空（这代表已经有线程在等待匹配了），那么当前线程尝试匹配(cas),但是cas只能允许一个线程成功,那么失败的线程就会进入到第三个分支：*也即节点不为空,但是cas失败*

![](images/DwzCbMMvjo7NH6xnAhZcLIudntg.png)



![](images/HNfhbIGjjopwHXxzok0cinYYn70.png)
...
![](images/LfhIb8QX8oGgwkxOx0YcVqNWn3f.png)
...
![](images/Tk7RbTebloZSKixrY1YcEcR0nvh.png)



而这第三种情况就是通过cas设置bound的值来完成的,如下图所示：此时线程能够操作的下标值就不是0了，而是0和1了

![](images/FOjkbMzaeoj88SxstpCc7t7knug.png)
...
![](images/Mn1nbatTAoE43pxtGSqcgfMPnSe.png)



下面继续看下,当m!=0时的操作,如下图所示：

![](images/Xv8ObZvHco2jVRx8IkMcP4Geneg.png)
