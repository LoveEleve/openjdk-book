...
```excalidraw-btn
{
	...
	"elements": [
		...
		},
		{
			...
			"seed": 1598808955,
			"version": 5,
			"versionNonce": 1357338267,
			"isDeleted": false,
			"boundElements": null,
			"updated": 1769343550446,
			"link": null,
			"locked": false,
			"text": "e1",
			"rawText": "e1",
			...
			"containerId": "orKnX9DHaKpbc-tAsZnZk",
			"originalText": "e1",
			"autoResize": true,
			"lineHeight": 1.25
		}
