...
![](images/线程本地变量-2-ZADdbsGM1oyKWaxGVQ1cFv9Unkt.png)
...
![](images/线程本地变量-2-ByrKbTeCto9klNxCk8pc2Pdbn5d.png)



在InheritableThreadLocal类中没有新增加的属性，只有三个方法&#x20;

![](images/线程本地变量-2-CGFKbyF3IosLUCxzGzecheHLnFc.png)
...
![](images/线程本地变量-2-EbNmb1Zi7oqEqkxKearcUQqZnRf.png)
...
![](images/线程本地变量-2-HHC7bGxI7oMkxOxfpDFcqxGin71.png)
...
![](images/线程本地变量-2-Fyi5birNioFEBQxRDtjc0zwtnCv.png)
...
![](images/线程本地变量-2-DxL7bN1xGo6sD7xN4EycUMT5nSb.png)
...
![](images/线程本地变量-2-Zk3HbjtRMowsVcxn28scMOR0nth.png)
...
![](images/线程本地变量-2-HX0Mb14SeolPSjxoJlCcQ9B2nHd.png)
...
![](images/线程本地变量-2-Japqby1MdoC9k8x2eIBcG0pun8e.png)



暴露出disableIgnoreNullValueSemantics属性来影响空值的操作,在这里会调用super.set(value)来存储值,此时结构如下：&#x20;

![](images/线程本地变量-2-Pnt2bWXMRou8N4x45encGA71nhb.png)
...
![](images/线程本地变量-2-CGEnbODX4oqDQxxdv6IcmJaanQh.png)
...
![](images/线程本地变量-2-MMXZb6XlRoLxnbxj4PjcYh1znPe.png)
...
![](images/线程本地变量-2-Lzq3b2K7Po6FCNxZmqucJOxgn7d.png)



在看capture方法之前,需要先介绍一个类：Transmitter，这个就是专门负责实现跨线程的线程本地变量传输功能。 并且这个类中有7个静态属性

![](images/线程本地变量-2-R2cRbd2CJoHVvhxXhiLc4Zqcn8d.png)



在这里先关心前面3个类属性，此时的结构为：&#x20;

![](images/线程本地变量-2-Fx50b8krRoTy6uxcHaUccX0hnPg.png)
...
![](images/线程本地变量-2-Vsn7bTIZvo3sC6xwkEBcH66gnyf.png)



然后继续看TtlRunnable的构造方法

![](images/线程本地变量-2-AFtobJbjmoKJXmx3z6lcfYOXnSb.png)
...
![](images/线程本地变量-2-H8hZbLyiXokq1BxraLzcGIb1nnf.png)
...
![](images/线程本地变量-2-Ikppbx0p0oKMSxxD7xhcZ7S8ncf.png)

部分图

完整图

![](images/线程本地变量-2-LG1JbKuVSokerHx1ms6cok7Lnog.png)
...
![](images/线程本地变量-2-TW0EbgFudoxMjPxwyUlc9N9vnNc.png)
...
![](images/线程本地变量-2-LoWzbHw6moBeqWxYBOacerYpnBe.png)
