...
![](images/XNXsbkPCJoWLBZxEIwYcrVzan2f.png)
...
![](images/TKRhbWDieoBgsexLboScZZiMnbb.png)

ThreadLocalMap与Thread的关系

### 类关系图

![](images/XPbwbeXP8oiTmyxhUbwc12Gon6c.png)



### 源码解析

![](images/Y9gRbxULHoaFM6xqvXfcaWlbnUg.png)
...
![](images/RlTMbiQcNorx2NxXHM3cdQNYnUf.png)



这里的HASH\_INCREMENT的作用等后续在说明,下面继续看代码

![](images/OShLbByneoQzfvx8e6icNrK9nrf.png)
...
![](images/Ci26bDnkGodZFExpietcYCA3n1c.png)
...
![](images/Izkwb1YkpoVtdPxgUoacwQ3pnIc.png)
...
![](images/Pzo7btS73ouRyWx33rhcgNu3nOc.png)
...
![](images/JezGbZztqotZLxxGHh9cwwJRnjd.png)
...
![](images/JVsObcyeUouTEyxgXDVcrwqanpd.png)
...
![](images/XJgLbMBbGorFv4xIefYcKCWVnHh.png)
...
![](images/QKyCbgJHoopU4VxM61JcG5mtn4c.png)
...
![](images/ILHkbubsPoLRmPxvUV2cNT4sntf.png)

图-1

![](images/X3qeboA1Co56tSxvhBmcUPs2nId.png)
...
![](images/L16ibFcCio5y0Pxr1W0cQHyEnhc.png)
...
![](images/BHVobELZ6oaUG7xkayIcS0wnn10.png)



疑问：如下图所示&#x20;

![](images/JlnNb5sjfo7nBOxTxVecNWbSnMs.png)



这个疑问先保留,继续看后续两个清理的方法：&#x20;

![](images/QyT0b1HSsobVrjxaWNpc5co0n6c.png)
...
3. See Knuth,Section6.4 计算机科学名著 ***Donald Knuth&#x20;***&#x7684;**《**&#x54;he Art of Computer Programmin&#x67;**》**（计算机程序设计艺术）第 6.4 节 在这一节详细的讨论了哈希表的各种算法,这里使用的正是其中一种标准的删除处理算法
...
![](images/WCP4byAaco3AnDxqdxVcutdzn5f.png)



那么再来解释一下为什么这里的操作能够解答我上面的疑问：&#x20;

![](images/BQPGbSX8NoLbzPxroAAcauzanyc.png)
...
![](images/Hgsxbi4kHoYG5yxE3mpcBWPtnQf.png)
...
![](images/Eg9ebwUrToewgMxZ5l6cb0kNn5d.png)
...
![](images/Ft3ObwfAqo98COxpSOYclt8SnDg.png)



下面在介绍一下get()方法：代码很简单,不在赘述，不过要更新一下清理的时机&#x20;

![](images/TWarb3fkCo17EXxOyJhcXANjnpb.png)
...
![](images/D436bdhCEomPujxs4slcyAAlnGh.png)
...
![](images/FAbkbu9Pko9VhhxxmrVcnmeinmd.png)
...
![](images/HywKbAVk2oDHfWxWYjGcweOOnue.png)
...
![](images/Ymuab9UkXoiK6txl9iccIpP7nkf.png)
...
![](images/OQ3wbwaQ3oTjekxWVCDcRdFAn9e.png)



在这里又需要更新一下清理的时机：

![](images/BtnubQpoXo94KQxyI6RcgrjBnqg.png)



在这里总结一下内存泄露：&#x20;

![](images/KyC3bi9lFo5B1pxmGW1cCn8jnae.png)



到这里关于threadlocal的介绍就介绍了,后续代补充的内容如下：&#x20;

![](images/ScBsbh8lfohSIsxVMK4cLOLInVi.png)
