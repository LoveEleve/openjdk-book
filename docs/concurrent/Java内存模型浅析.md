...
> 这里编译器指的是什么呢？是javac吗? 是gcc吗？我认为不是的，这里应该指的&#x662F;**<span style="color: rgb(216,57,49); background-color: inherit">JIT(C1/C2编译器)</span>**
...
> 在书中讲解了 非同步的顺序一致性，但是我觉得没意义，并且书中也说了，这是一种理想化的模型，在这里重点掌&#x63E1;**<span style="color: rgb(216,57,49); background-color: inherit">JMM对数据竞争的定义</span>**
